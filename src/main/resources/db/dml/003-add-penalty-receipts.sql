...
INSERT INTO `penalty_receipts` (`type_id`, `tax`, `penalty_receipt_sum`) VALUES ((SELECT `id` FROM `penalty_receipt_types` WHERE `name` = 'Penalty because of late obtaining'), 0.05, 250.05);
...
INSERT INTO `penalty_receipts` (`type_id`, `tax`, `penalty_receipt_sum`) VALUES ((SELECT `id` FROM `penalty_receipt_types` WHERE `name` = 'Penalty because of loss'), 0.15, 949.99);
