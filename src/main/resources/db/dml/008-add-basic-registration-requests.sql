...
VALUES ((SELECT `id` FROM `unregistration_requests` WHERE `municipal_service_certificate_number` = 'THJN1'), 'THJN1', 'QQ', 852455);
...
INSERT INTO `registration_requests` (`unregistration_request_id`, `registration_permit_number`, `national_passport_series`, `national_passport_number`)
VALUES ((SELECT `id` FROM `unregistration_requests` WHERE `municipal_service_certificate_number` = 'THJN2'), 'THJN2', 'QQ', 852456);
...
INSERT INTO `registration_requests` (`unregistration_request_id`, `registration_permit_number`, `national_passport_series`, `national_passport_number`)
VALUES ((SELECT `id` FROM `unregistration_requests` WHERE `municipal_service_certificate_number` = 'THJN3'), 'THJN3', 'QQ', 852457);
...
INSERT INTO `registration_requests` (`unregistration_request_id`, `registration_permit_number`, `national_passport_series`, `national_passport_number`)
VALUES ((SELECT `id` FROM `unregistration_requests` WHERE `municipal_service_certificate_number` = 'THJN4'), 'THJN4', 'QQ', 852458);
